...
export const SET_LEVERAGE = {
  url: "/v1/account/symbol-leverage",
...
export const LEVERAGE_BRACKET = {
  url: "/v1/account/leverage-brackets",
  reqType: REQUEST_TYPE.GET
};
...
export const CHECK_USER_NAME_VALIDATION = {
  url: "/v2/fuzzyMatch",
  reqType: REQUEST_TYPE.GET
};
export const CHECK_USER_IFSC_VALIDATION = {
  url: "/v2/validateIFSC",
  reqType: REQUEST_TYPE.GET
};
...
export const CLOSE_ALL_POSITIONS = {
  url: "/v1/futures/close-all-positions",
  reqType: REQUEST_TYPE.POST
};
...
export const FETCH_ORDER_HISTORY = {
  url: "/v1/futures/query-order?wantTrade=true&StartTime={0}&Endtime={1}&symbol={2}&orderType={3}&side={4}&reduceOnly={5}&status={6}&size={7}&page={8}",
  // url: "/v1/futures/order?wantTrade=true&StartTime={0}&Endtime={1}&symbol={2}&orderType={3}&side={4}&reduceOnly={5}&status={6}&size={7}&start={8}",
  reqType: REQUEST_TYPE.GET
};
...
export const GET_MARGIN_TYPE = {
  url: "/v1/account/margin-type?symbol={0}",
  reqType: REQUEST_TYPE.GET
};

export const CHANGE_MARGIN_TYPE = {
  url: "/v1/account/margin-type",
  reqType: REQUEST_TYPE.PUT
};
...
export const GET_STRATEGY_ORDER_DATA = {
  url: "/v1/futures/{0}/strategy-orders",
  reqType: REQUEST_TYPE.GET
};

export const PLACE_STRATEGY_ORDER = {
  url: "/v1/futures/strategy-order",
  reqType: REQUEST_TYPE.POST
};
...
export const GET_STRATEGY_ORDER_DATA_BY_ID = {
  url: "/v1/futures/strategy-order?childOrderID={0}",
  reqType: REQUEST_TYPE.GET
};
export const UPDATE_STRATEGY_ORDER = {
  url: "/v1/futures/orders",
  reqType: REQUEST_TYPE.PUT
};
