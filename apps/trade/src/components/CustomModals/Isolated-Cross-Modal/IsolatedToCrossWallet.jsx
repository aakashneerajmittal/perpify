...
const IsolatedToCrossWallet = ({ marginType, symbol = "BTCUSDT", IsOpen, close }) => {
  ...
  const getPositionAndOrderIndex = () => {
    ...
    const openOrderIndexFormStream = openOrdersSocketData.findIndex((activeOrder) => activeOrder.s === symbol.toUpperCase());
