...
import { getRowColor, SymbolPrecisionHelper } from "@/helpers";
    ...
    <>
      <Grid
        ...
        sx={{
          p: 2.5,
          alignItems: "center",
          // backgroundColor: getRowColor(1, rowData),
      ...
      <OrderSummaryModal
        ...
        type="DISPLAY"
        dataOrderId={rowData.orderId}
        updated={rowData.updatedTime}
        TotalFee={rowData.totalFee}
        TotalPL={rowData.totalPnL}
        trades={rowData?.trades ?? []}
        secondaryAction={() => {
