...
const OrderFormCalculatorModal: React.FC<CalculatorProps> = ({ isCalculatorOpen, setIsCalculatorOpen }) => {
  ...
  const calculateMaintenanceMargin = () => {
    const leverageData = leverageBracket.filter((leverageEntry: any) => leverageEntry?.symbol === selectedSymbolFromCalculator)[0].brackets;
  ...
  useEffect(() => {
    ...
    if (leverageBracket.length > 0) {
      setMaxLeverage(leverageBracket.filter((symbol: any) => symbol?.symbol === selectedSymbolFromCalculator)[0].brackets[0]?.initialLeverage);
    }
  ...
  useEffect(() => {
    if (leverageBracket.length) {
      setMaxNotional(
        leverageBracket.filter((symbol: any) => symbol.symbol === selectedSymbolFromCalculator)[0].brackets.filter((filter: any) => filter.initialLeverage === Number(leverage))[0]?.notionalCap
      );
    }
      ...
      case "fees":
        return (
          <Box>
            ...
            {isCalculationsExpanded && (
              <Box>
                ...
                <Box sx={{ marginBottom: "0.75rem" }}>
                  <TextView
                    id="calculator-roe-calculation-formula"
            ...
            <TextView
              id="calculator-funding-deduction"
              text={
            ...
            <Box sx={{ backgroundColor: "background.secondary", p: "1rem" }}>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  ...
                  <Box>
                    <TextView id={"search-symbol"} component={"p"} variant="bold_16">
                      {selectedSymbolFromCalculator}
                    </TextView>
                  </Box>
                </Box>
                      ...
                      {tradeableSymbols
                        ...
                        ?.map((symbol: any, ind: number) => (
                          ...
                          >
                            ...
                            <Box>
                              <TextView id={`symbol-row-${ind}`} text={symbol.symbol} variant={"Bold_14"} />
                            </Box>
                          </MenuItem>
                        ))}
                    </Box>
              ...
              <Box sx={{ marginTop: "1rem", height: "275px" }}>
                  ...
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">
                        <>
                          <TextView id="calculator-entry-price-last" onClick={handleLastEntryPrice} component="p" variant="Bold_12" style={{ cursor: "pointer" }}>
                            Last
                          </TextView>
                        </>
                      </InputAdornment>
                  ...
                  <BasicTextFields
                    ...
                    InputProps={{
                      endAdornment: (
                        <InputAdornment position="end">
                          <>
                            <TextView id="calculator-entry-price-last" onClick={handleLastExitPrice} component="p" variant="Bold_12" style={{ cursor: "pointer" }}>
                              Last
                            </TextView>
                          </>
                        </InputAdornment>
                    ...
                    InputProps={{
                      endAdornment: (
                        <>
                          <InputAdornment position="end">
                            <>
                              <TextView id="calculator-contract-size-min" onClick={handleMinClickForQuantity} component="p" variant="Bold_12" style={{ cursor: "pointer" }}>
                                Min
                              </TextView>
                            </>
                          </InputAdornment>
                ...
                {isolatedCrossToggle === "CROSS" && (
                  <>
                    <Box sx={{ marginTop: "0.5rem" }}>
                      <BasicTextFields
                        id="calculator-wallet-balance-input"
                ...
                >
                  ...
                  >
                    {calculatorTabs.map((data, index) => (
                      <TabPrimary label={data.label} key={index} value={data.value} id={`calculator-${data.value}`} />
                    ))}
                  </Tabs>
                </Box>
