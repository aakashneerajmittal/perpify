  ...
  return (
    <>
      ...
      >
        ...
        {/* <TextView component={"h4"} variant="Medium_14" text="Bank Name" color="text.secondary" /> */}

        <TextView style={{ pt: "15px" }} component={"p"} variant="Medium_16" text={item?.bankName} />
      </Grid>
      <Grid
        item
        flex={1}
      ...
      >
        ...
        <TextView component={"p"} variant="Medium_16" text={item.ifsc?.toUpperCase()} style={{ pt: "10px" }} />
      </Grid>
      <Grid
        flex={1}
        sx={{
