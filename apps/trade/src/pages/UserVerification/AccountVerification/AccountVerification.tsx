...
const AccountVerification = () => {
  ...
  const [isAttemptLoader, setIsLoader] = useState({
    id: "",
    open: false,
    type: "",
    title: "",
  ...
  return (
    <>
      ...
      <BankVerificationModal setIsLoader={setIsLoader} attemptsLeft={getBankDetails?.attemptsLeft} IsOpen={isBankVeriOpen} action={AddBankAccount} handelClose={() => setisBankVeriOpen(false)} />
      ...
      />
      <StatusModal
        loader={isAttemptLoader}
        IsOpen={isAttemptLoader.open}
        type={isAttemptLoader.type}
        title={isAttemptLoader.title}
        primaryMessage={isAttemptLoader.primaryMessage}
        secondaryMessage={isAttemptLoader.secondaryMessage}
        close={() =>
          setIsLoader({
            ...isAttemptLoader,
            open: false,
