...
/** Mint (or reuse) the burner wallet and mark the session logged-in. Returns the address. */
...
/** Forget the burner wallet (logout). Keeps everything else in localStorage intact. */
