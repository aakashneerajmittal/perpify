...
// import AccountSummary from "@/components/Portfolio/NewPortfolio/AccountSummary/AccountSummary";
import Wallet from "@/pages/UserProfile/Wallet/Wallet";
// import MWallet from "@/pages/MobileView/Wallet/MWallet";
...
export default function AppRouter() {
  ...
  // useEffect(() => {
  //   if (isLoggedIn) dispatch(fetchUserPersonna());
  // }, [isLoggedIn]);
...
{/* 
          ...
          <Route path="/fullscreenchart/:symbol" element={<TradingViewFullScreenChartContainer />} />
